...
def build_model(model_name, n_classes, chans, samples, dataset_name, cfg):
    ...
    if model_key == "Conformer":
        from models.Conformer import Conformer, AdversarialConformer
        args = dict(base_args)
        ...
        from models.DeepConvNet import DeepConvNet, AdversarialDeepConvNet
        args = dict(base_args)
        use_adv = bool(_pop(args, "enable_adversarial_head", "use_adversarial_head", default=False))
        adv_lambda = _pop(args, "adv_lambda", default=0.01)
        n_nuisance = _pop(args, "n_nuisance", "n_nuis", default=None)
        ...
        adv_kwargs = dict(params)
        # remove keys handled explicitly in AdversarialDeepConvNet signature
        adv_kwargs.pop("n_classes", None)
        return AdversarialDeepConvNet(
            n_classes=n_classes,
            n_nuisance=n_nuisance or chans,
            lambd=adv_lambda,
            **adv_kwargs,
        ...
        from models.ShallowConvNet import ShallowConvNet, AdversarialShallowConvNet
        args = dict(base_args)
        use_adv = bool(_pop(args, "enable_adversarial_head", "use_adversarial_head", default=False))
        adv_lambda = _pop(args, "adv_lambda", default=0.01)
        n_nuisance = _pop(args, "n_nuisance", "n_nuis", default=None)
        ...
        adv_kwargs = dict(params)
        # remove keys handled explicitly in AdversarialShallowConvNet signature
        adv_kwargs.pop("n_classes", None)
        return AdversarialShallowConvNet(
            n_classes=n_classes,
            n_nuisance=n_nuisance or chans,
            lambd=adv_lambda,
            **adv_kwargs,
